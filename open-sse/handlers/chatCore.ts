...
export async function handleChatCore({
  ...
  try {
    if (nativeCodexPassthrough) {
      ...
      // payloads at high context (150+ msgs, 100+ tools).
      // Cache_control markers are preserved in the shallow copy regardless
      // of preserveCacheControl since no translation step strips them.
      translatedBody = { ...body };
